        ...
        <div className="max-w-3xl text-left">
          ...
          <div className="mt-10 flex w-full flex-col items-start gap-4">
            ...
            <div ref={containerRef} className="relative w-full max-w-xl group">
              <div
                className={cn(
                  "relative flex items-center rounded-full border border-slate-200 bg-white px-2 shadow-2xl transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)] focus-within:shadow-[0_20px_50px_rgba(0,0,0,0.15)] focus-within:-translate-y-1 focus-within:ring-4 focus-within:ring-white/10",
                  isExpanded &&
