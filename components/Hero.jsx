        ...
        <div className="mt-8 flex flex-wrap justify-center gap-2 sm:gap-3 max-w-xl mx-auto">
          {POPULAR_CATEGORIES.map((cat) => (
            <Link
              key={cat.href}
              href={cat.href}
              className="rounded-full bg-muted/50 border border-border/60 hover:border-foreground/30 hover:bg-muted text-foreground hover:text-foreground text-[12px] sm:text-[14px] font-medium px-3 py-1.5 sm:px-5 sm:py-2 transition-colors"
            >
              {cat.label}
            </Link>
          ))}
...
//         {/* Trust Badge */}
//         <div className="mb-6 inline-flex items-center justify-center px-4 py-1.5 text-sm font-medium text-muted-foreground">
...
//           <span className="block">Find Your Next Home in the GTA</span>
...
//         <div
//           ref={containerRef}
//           className="relative mt-10 w-full max-w-3xl mx-auto px-2"
//         >
//           <div
//             className={cn(
