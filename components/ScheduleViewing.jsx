        ...
        <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto rounded-2xl overflow-hidden bg-[#f4f3f1] border border-gray-200">
              ...
              {dates.map((date) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-shrink-0 w-16 sm:w-20 h-24 sm:h-28 rounded-xl border-2 flex flex-col items-center justify-center transition-all ${active
              ...
              {times.map((slot) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full px-3 sm:px-4 py-3 rounded-xl border-2 text-left transition-all ${active
                        ? "border-black bg-white"
                        : "border-gray-300 hover:border-gray-500 bg-transparent"
                      }`}
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <button
              ...
              disabled={loading}
              className={`bg-black cursor-pointer hover:bg-black/85 text-white py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all ${loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
            >
